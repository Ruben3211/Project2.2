...
?>
                <li><a href="layout.php?name=<?php echo $_SESSION['city'][$x] . "#" . $_SESSION['city'][$x]; ?>" class="<?php if(strtoupper($_GET["name"]) == strtoupper($_SESSION['city'][$x])){ echo "active";} else{ echo "passive"; } ?>"> 
